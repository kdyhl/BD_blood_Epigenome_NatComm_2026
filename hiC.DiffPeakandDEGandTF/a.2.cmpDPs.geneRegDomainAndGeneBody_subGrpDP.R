...
dir.ou="a_2_cmpDP.geneRegDomainVSgeneBody_V1.1_rmOvlpPk/DP.V1.5.1_subgrp_meta_V1.2.1/"
dir.create(dir.ou, recursive = T, showWarnings = F)
file.ou.RData=paste0(dir.ou, SUBGRP, ".geneRegDomainVSgeneBody.metaDP.RData")
file.ou.pdf=paste0(dir.ou, SUBGRP, ".geneRegDomainVSgeneBody.metaDP.pdf")
#
