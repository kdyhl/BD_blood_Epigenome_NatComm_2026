...
sh.head = paste("#!/bin/bash",
                ...
                sep="\n")
script= "b.testEpiDEGvsCMapSignatures.py" #"a.4.callTisshaQTL_fixedCov_V1.2.2_filtPk_gINT.Peer_rmSexAge.R" #"a.4.callTisshaQTL_fixedCov_gINT.R"
JOB.N=50
EXP.N=49550
...
files.in.degs=c(dnDEG="a_3_DEG_meta.geneBodyAndgeneRegDom_V1.2.5conds/DEG.metaDP.DEGs.dn.gid_byDAVID.txt", 
            upDEG="a_3_DEG_meta.geneBodyAndgeneRegDom_V1.2.5conds/DEG.metaDP.DEGs.up.gid_byDAVID.txt")
dir.ou = "b_comp2CompoundSig_cMap_V1.1/"
...
for (i in 1:JOB.N)
{
  ...
  f.o.sh = paste0("b.testEpiDEGvsCMap_V1.1.", i, ".sh")
