...
SUBGRP=args[1] #"nonInflamSubgrps"#"inflamSubgrps" #
...
file.in.geneBody.meta.RData = paste0("a_geneBody_DP_meta_V1.2.1_filtByDist_allGenes/DP.V1.5.1_inflamSubgrp/", SUBGRP, ".genebody.DP.meta.RData")
file.in.geneRegDom.meta.RData = paste0("a_2_cmpDP.geneRegDomainVSgeneBody_V1.1_rmOvlpPk/DP.V1.5.1_subgrp_meta_V1.2.1/", SUBGRP, ".geneRegDomainVSgeneBody.metaDP.RData")



dir.ou="a_3_DEG_meta.geneBodyAndgeneRegDom_V1.2.5conds_subGrpDP/"
dir.create(dir.ou, recursive = T, showWarnings = F)
#file.ou.RData=paste0(dir.ou, "geneRegDomainVSgeneBody.metaDP.RData")
file.ou.pdf=paste0(dir.ou, SUBGRP, ".DEG.metaDP.byGene.hg19.pdf")
file.ou.RData=paste0(dir.ou, SUBGRP, ".DEG.metaDP.DEGs.RData")
files.ou.txt=c(up=paste0(dir.ou, SUBGRP, ".DEG.metaDP.DEGs.up.txt"),
               dn=paste0(dir.ou, SUBGRP, ".DEG.metaDP.DEGs.dn.txt"))

file.ou.upset.pdf=paste0(dir.ou, SUBGRP, ".DEG.metaDP.upset.hg19.pdf")
#
...
FUN=function(cond)
{
  ...
  write(gene2info[gs.filt,  "geneName"], 
    file=paste0(dir.ou, SUBGRP, ".DEGs.filt.supBy.", cond, ".pCUTOFF", DEG.P.permCUTOFF,".txt"))
