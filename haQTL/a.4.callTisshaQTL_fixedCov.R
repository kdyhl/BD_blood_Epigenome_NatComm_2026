...
file.in.totalVCF = "Kellis.WGS.subsetFromBiobank.hg38.snp.MAF0.05.locID.vcf.gz"

#file.tmp.inds = paste("/broad/hptmp/lhou/m6A/inds.txt", sep="")
dir.tmp="~/hptmp/MayoBipolar/a_4_haQTL_V1.2.3_dp_bg/" #"~/hptmp/eGTEx-H3K27ac/a_2_haQTL_V1.2_quant_peer/"
...
dir.ou=paste0("a_4_haQTL_FixedFactorNum_V1.2.3_DP.BG_", CIS.WIND.LEN/1000, "k/")#"a_2_haQTL_testFactorNumFromRUVg_withGTExMinCov_V1.2_quant_peer
