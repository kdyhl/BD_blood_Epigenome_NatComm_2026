#V1.2.3.1
#a.4.callTisshaQTL_fixedCov_V1.2.3.1.paral
...
sh.head = paste("#!/bin/bash",
                ...
                "source ~/.my.bashrc",
                sep="\n")
script= "a.4.callTisshaQTL_fixedCov_genotypePC.R" #"a.4.callTisshaQTL_fixedCov_V1.2.2_filtPk_gINT.Peer_rmSexAge.R" #"a.4.callTisshaQTL_fixedCov_gINT.R"

# dir.in.eQTL = "~/lhou.compbio/codes/eGTEX-H3K27ac/b.GTEx_eQTL_V8_MAFfilt/"
# files.in.eQTL.RData = dir(dir.in.eQTL, ".RData", full.names =T)
# #dir.in.plink = "/broad/compbio/data/GTEx/GTEx_restricted/v8_plink/plink/"
#  

#file.tmp.eQTL.filt = paste(dir.tmp, "Brain_Frontal_Cortex_BA9.allpairs.filt.txt", sep="")

# 
# dir.ou=paste("./d_m6AQTLVSeQTL_", eQTL.P.cutoff, "_V1.2_nonLD/", sep="")
# if(! dir.exists(dir.ou))
# {
#   dir.create(dir.ou)
# }
# file.ou.pref=paste(dir.ou, TISS, sep="")
#file.ou.pdf = paste(dir.ou, "enhQTL.brainV1VSeQTL.pdf", sep="")

#file.ou.enhQTLVSeQTL.RData = paste(dir.ou, "enhQTLVSeQTL.RData", sep="")
#
