...
REFs.SELECT= c("E040","E039", "E048", "E047", "E029", "E032", "E046", "E030")# ,"  "BPNeutrop") #use neutrophil from ROADMAP instead of blueprint
...
boxplot(size2pval, xlab="number of peaks overlapped with merged peaks", ylab="pvalues", outline=F)
boxplot(size2SecondTopPval[1:500], xlab="number of peaks overlapped with merged peaks", ylab="2nd largest pvalues", outline=F)
boxplot(pk2len~pk2pvals.size, xlab="number of peaks overlapped with merged peaks", ylab="peak length", outline=F)
...
# 
save(merged.peaks, merged.peaks.len, qc.info,file=file.ou.RData)
